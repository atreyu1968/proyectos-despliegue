...
import { Settings, Palette, Database, Layout, Link, CheckSquare, KeyRound, FileText, Shield, MessageSquare, Bell } from 'lucide-react';
...
import MessagingPermissionsSettings from '../components/system-settings/MessagingPermissionsSettings';
import NotificationPermissionsSettings from '../components/system-settings/NotificationPermissionsSettings';
...
const SystemSettingsPage: React.FC = () => {
  ...
  const tabs = [
    ...
    { id: 'messaging', label: 'Permisos de Mensajería', icon: MessageSquare },
    { id: 'notifications', label: 'Permisos de Notificaciones', icon: Bell }
  ];
  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      ...
      case 'messaging':
        return <MessagingPermissionsSettings {...commonProps} />;
      case 'notifications':
        return <NotificationPermissionsSettings {...commonProps} />;
      default:
        return <GeneralSettings {...commonProps} />;
    }
  };
