...
const ConvocatoriaForm: React.FC<ConvocatoriaFormProps> = ({
  ...
  const [formData, setFormData] = useState<Partial<Convocatoria>>({
    ...
    status: 'draft',
    maxProjectsPerCenter: 5, // Default value
    phases: {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">
              Máximo proyectos por centro
            </label>
            <div className="mt-1 relative">
              <input
                type="number"
                name="maxProjectsPerCenter"
                value={formData.maxProjectsPerCenter}
                onChange={handleInputChange}
                min="1"
              ...
              <div className="mt-1 text-xs text-gray-500">
                Límite de proyectos que puede presentar cada centro
              </div>
            </div>
          </div>
        </div>
