          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <div className="flex justify-between items-center mb-4">
                <div>
                  ...
                  <div className="mt-2 space-y-4">
                    <div>
                      <p className="text-sm font-medium text-gray-700">Importe propuesto:</p>
                      <p className="text-lg font-semibold text-blue-600">{review.proposedAmount}€</p>
                    </div>
                    {review.amountJustification && (
                      <div>
                        <p className="text-sm font-medium text-gray-700">Justificación del importe:</p>
                        <p className="text-sm text-gray-600 mt-1">{review.amountJustification}</p>
                      </div>
                    )}
                  </div>
                </div>
              ...
              {review.generalObservations && (
                <div className="mt-4">
                  <h4 className="text-sm font-medium text-gray-700 mb-2">Observaciones generales:</h4>
