...
const ReviewModal: React.FC<ReviewModalProps> = ({
  ...
  useEffect(() => {
    if (initialData) {
      ...
      setProposedAmount(initialData.proposedAmount || 0);
      setAmountJustification(initialData.amountJustification || '');
    }
  }, [initialData]);
  ...
  const handleSave = async (isDraft: boolean) => {
    try {
      ...
      if (!isDraft && proposedAmount > (project.category?.totalBudget || 0)) {
        setError('El importe propuesto no puede superar el presupuesto máximo de la categoría');
        return;
      }
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="mt-1 relative rounded-md shadow-sm">
                    <input
                      ...
                      min="0"
                      max={project.category?.totalBudget}
                      step="100"
                      className="block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500"
                    />
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Máximo permitido: {project.category?.totalBudget}€
                  </p>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Justifica el importe propuesto..."
                  />
                </div>
